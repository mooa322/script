#!/bin/bash
wget https://www.dropbox.com/s/km2lm1ybucyw03p/list > /dev/null 2>&1
chmod +x list
...
echo ""
echo -e "\033[1;31m≠×≠×≠×≠×≠×≠×≠×[\033[1;33m • \033[1;32mBY @aʍɨʀռɛt71 ☆ @sᴛᴏᴘʜᴠᴘs\033[1;33m •\033[1;31m ]≠×≠×≠×≠×≠×≠×≠×\033[0m"
echo ""
...
pip install speedtest-cli && pip install -r /bin/requirements.txt
}
fun_bar 'inst_pct'
...
echo -e "\033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@StoPhVPS @AmirNet71\033[0m"
echo ""
toilet -f smmono9 "VPSPlus" |lolcat
