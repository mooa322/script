...
install_fun(){
    ...
    sed -i 's@^;date.timezone.*@date.timezone = Africa/Casablanca@' /etc/php/7.2/apache2/php.ini
...
if (\$data!="") {echo "Time Checker: \$data\n";}
if (\$level!="") {echo "level: \$level\n";}
if (\$pais!="") {echo "Parents: \$pais\n";}
if (\$brand!="") {echo "Type: \$brand\n";}
if (\$fone!="") {echo "Tel: \$fone\n";}
if (\$tipo!="") {echo "Type: \$tipo\n";}
PHP
}
echo -e  "\E[44;1;37m     VPSPLUS BIN Checker    \E[0m"
echo ""
echo -ne "Enter BIN: " && read UsrBin
while [[ ${#UsrBin} -lt 16 ]]; do UsrBin+="x"; done
echo -ne "How much do you want: " && read GerBin
