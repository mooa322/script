...
if [[ -e /etc/openvpn/server.conf ]]; then
  ...
  rmt2='mms.orange.fr/M3ALM_MAHBOUB'
  prx='200.142.130.104'
  vivo1="mms.orange.fr/"
                        ...
                        then
                          ...
                          if [[ -e /etc/openvpn/server.conf ]]; then
                              ...
                              if [[ "$resp" = @(s|S) ]]; then
                                ...
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP/Proxy: \033[1;37m$IP" ; echo -e "\033[1;32mUsername: \033[1;37m$username" ; echo -e "\033[1;32mPassword: \033[1;37m$password" ; echo -e "\033[1;32mExpire: \033[1;37m$gui" ; echo -e "\033[1;32mLimite: \033[1;37m$sshlimiter" ; echo -e "====================" |lolcat ;
mine_port ; echo -e "====================" |lolcat ; echo -e "\033[1;36mSupport:" ; echo -e "\033[1;95m➩ Online Games" ; echo -e "\033[1;91m➩ ʏᴏᴜᴛᴜʙᴇ ʜᴅ" ; echo -e "\033[1;92m➩ Whatsapp Video call " ; echo "" ; echo "" || echo "Unable to create user!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
