...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%35s%s%-20s\n' "VPSPLUS Payload Generator" ; tput sgr0
...
echo -ne "Select the Request Method: " && read valor3 #Metodo Requisicao
echo -e "[1] realData
[2] netData
[3] raw"
echo -ne "Select the Connection Method: " && read valor4 #Metodo Conexao
case $valor3 in
    1)req="GET";;
    2)req="CONNECT";;
    3)req="PUT";;
...
echo -e "Generated Payloads ... Testing ..."
barra="\033[1;36m=====================================================================================" |lolcat
echo -e "$barra"
while read payload; do
#echo -e "\033[1;31mTestando Payload:\033[1;33m$payload"
echo -e "\033[1;36mPAYLOAD IN THE HTTP INJECTOR:\n $payload\n"
